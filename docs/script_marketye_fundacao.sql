...
-- migrations 20260911220000..20260917005941 do MarketYE (fundação + correções
-- da Fase 4 + reparo de robustez ao banco real: bucket privado marketplace-docs
-- e rotinas de QA 058/063/123 que não dependem mais de apagar empresa_cadastro),
-- exceto a de mobiliário (a de
...
-- ---------------------------------------------------------------------
-- 20) QA robusta ao banco real: bucket marketplace-docs + rotinas 058/063/123 (sem DELETE em empresa_cadastro)
-- ---------------------------------------------------------------------
-- ============================================================================
