...
const PLANOS: Plano[] = [
  {
    ...
    modulos: [
      ...
      "Documentos",
      "Férias + Atestados",
      "NR-1 básico + Visão Psicossocial",
      "Ponto & Jornada disponível como add-on",
    ],
  },
  {
    id: "essential",
  ...
  },
  {
    ...
    modulos: [
      ...
      "Benefícios + Documentos + Hub Contábil + Financeiro",
    ],
  },
  {
    id: "business",
    ...
    modulos: [
      "Tudo do Performance",
      "Estratégia / Identidade + Manual de Cultura",
      "Gestão multi-empresa e grupos econômicos",
      "KPIs operacionais avançados (em breve)",
      "Integrações ERP — TOTVS, SAP, Sênior, Gupy (em breve)",
      "Suporte prioritário",
    ],
  },
  {
    ...
    modulos: [
      ...
      "Onboarding assistido + atendimento dedicado",
      "SSO — login corporativo (sob consulta)",
    ],
  },
] as const;
